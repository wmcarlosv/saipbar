    ...
    success: function (response) {
      ...
      for (var key in response) {
        ...
        order_list_left +=
          ...
          '</span><p  class="oder_list_class" style="font-size: 16px;text-align:left;width: 125px;float: left;">Orden: <span class="running_order_order_number">' +
          order_name +
          '</span></p><img src="' +
          base_url +
        ...
        order_list_left +=
          ...
          "</span></p>";
        order_list_left +=
          '<p>Cliente: <span class="running_order_customer_name">' +
          customer_name +
          "</span></p>";
        order_list_left += "</div>";
        ...
        order_list_left += '<div class="order_condition">';
        order_list_left +=
          '<p style="font-size:16px;">Tiempo: <span id="order_minute_count_' +
          response[key].sales_id +
          '">' +
          minute +
    ...
    success: function (response) {
      ...
      for (var key in response) {
        ...
        order_list_left +=
          ...
          '" class="ir_display_none">' +
          response[key].order_status +
          '</span><p   class="oder_list_class" style="font-size: 16px;font-weight: bold;text-align:left;width:125px;float:left">Orden: <span class="running_order_order_number">' +
          order_name +
          '</span></p><img src="' +
          base_url +
          'assets/images/right-arrow.png" style="float: right;width: 13px;margin: 2px;transition: .25s ease-out;" class="running_order_right_arrow" id="running_order_right_arrow_' +
