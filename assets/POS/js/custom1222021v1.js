...
$(document).ready(function () {
    ...
    if ($(".single_notification_checkbox:checked").length > 0) {
      swal(
        ...
        function () {
          let notifications = "";
          let j = 1;
          let checkbox_length = $(".single_notification_checkbox:checked")
            .length;
        ...
        for (let key in response.items) {
          ...
          if (selected_modifiers != "") {
            ...
            draw_table_for_hold_order +=
              ...
              this_item.food_menu_id +
              '">' +
              (modifiers_price * this_item.qty).toFixed(2) +
              "</span></div>";
            draw_table_for_hold_order += "</div>";
          }
  ...
  $(document).on("click", ".single_last_ten_sale", function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#recent_sale_modal_details_vat").html(response.vat);
      },
      error: function () {
        alert(a_error);
      },
          ...
          function () {
            ...
            $.ajax({
              ...
              success: function (response) {
                ...
                $("#sub_total_discount_last_10").html("0.00");
                $("#all_items_discount_last_10").html("0.00");
                $("#recent_sale_modal_details_vat").html("0.00");
        ...
        success: function (response) {
          ...
          for (let key in order_object.items) {
            ...
            if (single_item.item_type == "Kitchen Item") {
              ...
              if (single_item.cooking_status == "Started Cookign") {
          ...
          $("#kitchen_status_").html(order_number);
  ...
  $(document).on("click", ".single_item", function () {
    ...
    let item_discount_amount = parseFloat(0).toFixed(2);

    //discount input value of modal
    let discount_input_value = 0;

    //get item/menu price from modal
    let item_price = parseFloat($("#price_" + item_id).html()).toFixed(2);

    //get item/menu price from modal without discount
    let item_total_price_without_discount = parseFloat(item_price).toFixed(2);
    ...
    let item_total_price = parseFloat(item_price).toFixed(2);
    ...
    //get modifiers price
    let modifiers_price = parseFloat(0).toFixed(2);
  ...
  $(document).on("click", ".edit_item", function () {
    ...
    let menu_id = $(this).attr("id").substr(10);
    ...
    for (let key in originalMenu) {
      ...
      modifiers +=
        "<div " +
        backgroundColor +
        ' class="modal_modifiers" data-price="' +
  ...
  $(document).on("click", ".modal_modifiers:visible", function (e) {
    ...
    let modifier_price = parseFloat($(this).attr("data-price")).toFixed(2);
    //get total modifier price
    // let total_modifier_price = parseFloat($('#modal_modifier_price_variable').html()).toFixed(2);
  ...
  $(document).on("click", "#table_button,#dine_in_button", function (e) {
    ...
    if (typeof sale_no !== "undefined") {
      ...
      $("#order_number_or_new_text").html("Nueva");
    }
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        for (let key in table_details) {
          ...
          tables_modal +=
            '<div class="floatleft fix column first_column">Orden</div>';
          tables_modal +=
            '<div class="floatleft fix column second_column">Tiempo</div>';
          tables_modal +=
            '<div class="floatleft fix column third_column">Personas</div>';
          tables_modal +=
            '<div class="floatleft fix column forth_column">Borrar</div>';
          tables_modal += "</div>";
  ...
  $(document).on("click", "#add_to_cart", function (e) {
    ...
    //get item/menu price from modal
    let item_price = parseFloat($("#modal_item_price").html()).toFixed(2);
  ...
  $(document).on("keyup", "#sub_total_discount1", function (e) {
    ...
    if (
      ...
      $("#sub_total_discount").val($(this).val());
      checkDiscountType();
    }
    do_addition_of_item_and_modifiers_price();
  });
  ...
  $(document).on("click", "#place_order_operation", function (e) {
    ...
    let total_items_in_cart = $(".order_holder .single_order").length;
    let sub_total = parseFloat($("#sub_total_show").html()).toFixed(2);
    let charge_type = $("#charge_type").val();
    let total_vat = parseFloat($("#all_items_vat").html()).toFixed(2);
    let total_payable = parseFloat($("#total_payable").html()).toFixed(2);
      ...
      if ($(".order_holder .single_order").length > 0) {
        ...
        $(".order_holder .single_order").each(function (i, obj) {
          ...
          let item_quantity = $(this)
            ...
            .html();
          let tmp_qty = $("#tmp_qty_" + item_id).val();
          let p_qty = $("#p_qty_" + item_id).val();
  ...
  // let direct_invoice_tool_tip_top_position = (parseFloat(direct_invoice_tool_tip_top)-parseFloat(direct_invoice_button_height)-parseFloat(20)).toFixed(2);
...
function update_all_total_price() {
  //get item quantity
  let item_quantity = parseFloat($("#item_quantity_modal").html()).toFixed(2);
  //get item unit price
  let item_unit_price = parseFloat($("#modal_item_price").html()).toFixed(2);
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      for (let key in response.items) {
        ...
        let selected_modifiers_price_array = selected_modifiers_price.split(
          ","
        );
        let modifier_divs = "";
...
function do_addition_of_item_and_modifiers_price() {
  ...
  if ($("#delivery_charge").val() != "") {
    delivery_charge_amount = $("#delivery_charge").val();
    $("#show_charge_amount").html(Number(delivery_charge_amount).toFixed(2));
  } else {
  ...
  if ($("#sub_total_discount").val() != "") {
    ...
    if (tmt_value_sub_total[1] == "") {
      ...
      $("#show_discount_amount").html(
        Number(sub_total_discount_amount).toFixed(2)
      );
    }
  } else {
    $("#show_discount_amount").html("0.00");
  }
  ...
  if (total_tax_custom) {
    $("#show_vat_modal").html(total_tax_custom.toFixed(2));
  } else {
    $("#show_vat_modal").html("0.00");
  }
...
function get_all_item_discount() {
  ...
  $(".single_order .first_portion .fifth_column span").each(function (i, obj) {
    ...
    // let this_item_discount = (parseFloat(this_item_discount)+parseFloat($(this).parent().parent().find('.item_discount').html())).toFixed(2);
    all_item_discount = (
...
function get_updated_sub_total() {
  ...
  //get sub total
  let sub_total = parseFloat($("#sub_total").html()).toFixed(2);
      ...
      for (let key in response) {
        ...
        if (i == 1) {
          order_list_left +=
            ...
            '" class="single_order fix txt_5" data-selected="unselected" id="order_' +
        ...
        order_list_left +=
          ...
          '</span> <p><span class="running_order_customer_name">Cliente: ' +
          customer_name +
          '</span></p> <i class="far fa-chevron-right running_order_right_arrow" id="running_order_right_arrow_' +
          response[key].sales_id +
          '"></i>';
        order_list_left +=
          '<p>Mesa: <span class="running_order_table_name">' +
          tables_booked +
          "</span></p>";
        order_list_left +=
          '<p>Mesero: <span class="running_order_waiter_name">' +
          waiter_name +
          "</span></p>";
        order_list_left +=
          '<p class="oder_list_class txt_1">Orden: <span class="running_order_order_number">' +
          order_name +
          "</span></p>";
        order_list_left += "</div>";
        order_list_left += '<div class="order_condition">';
        order_list_left +=
          '<p class="order_on_processing">Inicia Preparación: ' +
          total_kitchen_type_items +
          "/" +
          total_kitchen_type_started_cooking_items +
          "</p>";
        order_list_left +=
          '<p class="order_done">Listo: ' +
          total_kitchen_type_items +
          "/" +
          total_kitchen_type_done_items +
          "</p>";
        ...
        order_list_left += '<div class="order_condition">';
        order_list_left +=
          '<p  class="txt_4">Tiempo: <span id="order_minute_count_' +
          response[key].sales_id +
          '">' +
          minute +
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      for (let key in response) {
        ...
        if (i == 1) {
          if (last_key == key) {
            order_list_left +=
              ...
              '" data-done-cooking="' +
              total_kitchen_type_done_items +
              '" class="single_order fix txt_6"  data-selected="selected" id="order_' +
              response[key].sales_id +
              '">';
          } else {
            order_list_left +=
          ...
          if (last_key == key) {
            order_list_left +=
              ...
              '" data-done-cooking="' +
              total_kitchen_type_done_items +
              '" class="single_order fix txt_7"  data-selected="selected" id="order_' +
              response[key].sales_id +
              '">';
          } else {
            order_list_left +=
        ...
        order_list_left += '<div class="order_condition">';
        order_list_left +=
          '<p  class="txt_4">Tiempo preparación: <span id="order_minute_count_' +
          response[key].sales_id +
          '">' +
          minute +
          '</span>:<span id="order_second_count_' +
      ...
      for (let key in response) {
        ...
        if (i == 1) {
          order_list_left +=
            ...
            '" data-done-cooking="' +
            total_kitchen_type_done_items +
            '" class="single_order txt_5" data-selected="unselected" id="order_' +
            response[key].sales_id +
            '">';
        } else {
          order_list_left +=
            ...
            '" data-done-cooking="' +
            total_kitchen_type_done_items +
            '" class="single_order" data-selected="unselected" id="order_' +
            response[key].sales_id +
            '">';
        }
        order_list_left += '<div class="inside_single_order_container fix">';
        ...
        order_list_left +=
          '<p><span class="running_order_customer_name">Cliente: ' +
          customer_name +
          "</span></p>";
        order_list_left +=
          '<p>Mesa: <span class="running_order_table_name">' +
        ...
        order_list_left +=
          ...
          '" class="ir_display_none">' +
          response[key].order_status +
          '</span><p   class="oder_list_class txt_8" >Orden: <span class="running_order_order_number">' +
          order_name +
          '</span></p><i class="far fa-chevron-right running_order_right_arrow " id="running_order_right_arrow_' +
          response[key].sales_id +
          '"></i>';
    ...
    success: function (response) {
      ...
      for (let key in response.items) {
        ...
        draw_table_for_order +=
          ...
          '">' +
          this_item.menu_price_with_discount +
          "</span><i data-id='"+this_item.food_menu_id+"' class='fal fa-times removeCartItem'></i></div>";
        draw_table_for_order += "</div>";
        if (selected_modifiers != "") {
          draw_table_for_order += '<div class="second_portion fix">';
          draw_table_for_order +=
      ...
      $.each(JSON.parse(response.tables_booked), function (key_t, value_t) {
        ...
        table_book_row +=
          ...
          '">';
        table_book_row +=
          '<div class="floatleft fix column first_column">Nueva</div>';
        table_book_row +=
        ...
        success: function (response) {
          ...
          for (let key in response) {
            ...
            order_list_left +=
              ...
              '" class="ir_display_none">' +
              response[key].order_status +
              '</span><p  class="oder_list_class txt_3">Orden: <span class="running_order_order_number">' +
              order_name +
              '</span></p><i class="far fa-chevron-right running_order_right_arrow" id="running_order_right_arrow_' +
              response[key].sales_id +
              '"></i>';
...
<div>
    ...
    <p>1. Añadir Producto</p>
    <p>2. Cambiar Mesa</p>
    <p>3. Cambiar Todo en la Orden</p>
</div>`;
...
$(window).on("click", function (e) {
  if ($(e.target).closest("#show_running_order").length === 0) {
...
function remove_all_cart_future_info() {
  ...
  $(".all_items_vat_last_10_").html("0.00");
  $(".all_items_discount_last_10_").html("0.00");
  $(".delivery_charge_last_10_").html("0.00");
  $(".total_payable_last_10_").html("0.00");
  $(".recent_sale_modal_details_vat_").html("0.00");
  $(".item_order_details .modifier_item_details_holder").empty();
  $(".total_items_in_cart_last_10_").html("0");
  $(".sub_total_show_last_10_").html("0.00");
  $(".sub_total_last_10_").html("0.00");
  $(".total_item_discount_last_10_").html("0.00");
  $(".discounted_sub_total_amount_last_10_").html("0.00");
  $(".sub_total_discount_last_10_").html("0.00");
  $(".sub_total_discount_amount_last_10_").html("0.00");
}
$(document).on("click", ".feuture_preview_row", function () {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      $(".all_items_discount_last_10_").html(response.total_discount_amount);
      $(".delivery_charge_last_10_").html(response.delivery_charge);
      $(".total_payable_last_10_").html(response.total_payable);
      $(".recent_sale_modal_details_vat_").html(response.vat);
    },
    error: function () {
      alert(a_error);
    },
