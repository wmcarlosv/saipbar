$(function () {
    ...
    $(document).on('click','#add_tax',function(){
        ...
        show_tax_row += '<td><input type="text" name="taxes[]" class="form-control"/></td><td><input type="text" onfocus="select()" name="tax_rate[]" class="form-control integerchk" value=""></td>';
