$(function() {
    ...
    $('#stockValue').html(stock_value+': '+currency + $(
        '#grandTotal').val() +
        '<a class="top" title="" data-placement="top" data-toggle="tooltip" style="cursor:pointer" data-original-title="Calculado en base al último precio de compra y al ingrediente con stock negativo Cant/Monto no esta considerado"><i data-feather="help-circle"></i></a>'
    );
