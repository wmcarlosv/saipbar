...
session_start();
    ...
    switch ($step) {
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                            ...
                            <div class="bottom">
                                ...
                                <?php } else { ?>
                                <a href="index.php?step=0" class="btn btn-primary button_1">Siguiente</a>
                                <?php } ?>
                            </div>
                  </div>
                </div>
        ...
        if ($_POST) { 
            ...
            //need to change
            curl_setopt($curl_handle, CURLOPT_URL, 'https://ResetSv.com/');
            ...
            if ($object->status == 'success') {
                ...
                <form action="index.php?step=0" method="POST" class="form-horizontal">
                    ...
                    <div class="control-group" style="margin-left:25px;">
                        ...
                        <!-- modified -->
                        <input id="owner" type="hidden" name="owner" class="input-large" value="ResetSvco"  />
                    </div>
                    <div class="bottom" style="width: 100%; margin-left:25px; margin-top: 10px;">
        ...
        <div class="panel-group">
                ...
                <div class="panel-body">
                <h3 style="text-align: center;">Guardando configuración de la base de datos</h3>
        <?php
        if ($_POST) {
            ...
            if (mysqli_connect_errno()) {
                ...
                if (!$db_selected) {
                    if (!mysqli_query($link, "CREATE DATABASE IF NOT EXISTS `$db_name`")) {
                        echo "<div class='alert alert-error'><i class='icon-remove'></i> Database " . $db_name . " no existe y no se pudo crear. Cree la base de datos manualmente y vuelva a intentar este paso.</div>";
                        return FALSE;
                    } else {
        ...
        <div class="panel-group">
                ...
                <div class="panel-body">
        <h3 style="margin-left:25px; text-align: center;">Guardando configuración de la base de datos</h3>
        <?php
        if ($_POST) {
        ...
        if ($finished) {
            ...
            <h3 style="margin-left:25px; text-align: center; margin-top: 10px"><i class='icon-ok'></i> Instalación completa!</h3>
            <div style="margin-left:25px; margin-right: 50px; width: 90%; padding: 10px; border-radius: 5px; border: 1px solid #b5d6f6;">Please login now using the following credential:<br /><br />
                Email: <span style="font-weight:bold; letter-spacing:1px;">admin@ResetSv.com</span><br />Password: <span style="font-weight:bold; letter-spacing:1px;">123456</span><br /><br />
            </div> 
            <div style="margin-left:25px; margin-right: 50px; margin-top: 10px; width: 90%; padding: 10px; border-radius: 5px; border: 1px solid #b5d6f6;">Cambie sus credenciales después de iniciar sesión.
            </div>
            <div class="bottom"> 
