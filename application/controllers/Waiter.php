    ...
    public function update_cooking_status_ajax()
    {
        ...
        foreach($previous_id_array as $single_previous_id){
            ...
            if($cooking_status=="Started Cooking"){
                ...
                $notification = 'Item: '.$item_info->menu_name.' Esta listo para servir, Mesa: '.$sale_info[0]->table_name.', Cliente: '.$sale_info[0]->customer_name.', Orden: '.$order_name;
     ...
     /**
     * update cooking status, delivery, Para Llevar ajax
     * @access public
     * @return object
     * @param no
     */
