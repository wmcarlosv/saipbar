...
class Setting extends Cl_Controller {
    ...
    public function index($id = '') {
        ...
        if ($this->input->post('submit')) {
            ...
            $this->form_validation->set_rules('print_format', lang('print_format'), 'required|max_length[250]');
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $outlet_info['print_format'] =htmlspecialchars($this->input->post($this->security->xss_clean('print_format')));
