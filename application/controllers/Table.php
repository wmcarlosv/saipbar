...
class Table extends Cl_Controller {
    ...
    public function addEditTable($encrypted_id = "") {
        ...
        if ($this->input->post('submit')) {
            ...
            $this->form_validation->set_rules('rooms_id', lang('rooms_id'), 'required');
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $igc_info['rooms_id'] =htmlspecialchars($this->input->post($this->security->xss_clean('rooms_id')));
                ...
                if ($id == "") {
                    ...
                    $data['rooms'] = $this->Common_model->getAllByCompanyIdForDropdown($company_id, 'tbl_rooms');
