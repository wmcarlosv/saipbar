                            ...
                            <table class="table">
                                ...
                                foreach ($food_details as $key=>$value):
                                    ...
                                    <tr class="rowCount" data-item_id="<?=$value->ingredient_id?>" data-id="<?=$key?>" id="row_<?=$key?>">
                                        ...
                                        <td><span><?=getIngredientNameById($value->ingredient_id)?> <?=getIngredientCodeById($value->ingredient_id)?> </td>
                                        <td><?=$value->quantity_amount?> <?=unitName(getUnitIdByIgId($value->ingredient_id))?></td>
                                    </tr>
                                    <?php
                                endforeach;
                                ?>
