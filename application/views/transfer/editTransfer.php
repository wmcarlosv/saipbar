                ...
                <div class="box-body">
                    ...
                    <div class="col-md-3" style="display: <?=$received_date?>;">
                        ...
                        <?php if (form_error('received_date')) { ?>
                            <div class="alert alert-error ir_p_5">
                                <p><?php echo form_error('received_date'); ?></p>
                            </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="col-md-3"  style="display: <?=$received_date?>;">
                        ...
                        <?php if (form_error('from_outlet_id')) { ?>
                            <div class="alert alert-error ir_p_5">
                                <p><?php echo form_error('from_outlet_id'); ?></p>
                            </div>
                        <?php } ?>
                    </div>
                            ...
                            <table class="table">
                                ...
                                ?>
                                        <tr class="rowCount" data-item_id="<?=$value->ingredient_id?>" data-id="<?=$key?>" id="row_<?=$key?>">
                                            ...
                                            <td><span><?=getIngredientNameById($value->ingredient_id)?> <?=getIngredientCodeById($value->ingredient_id)?></span><input type="hidden" id="ingredient_id_<?=$key?>" name="ingredient_id[]" value="<?=$value->ingredient_id?>"></td>
                                            <td><input type="text" data-countid="1" tabindex="51"  value="<?=$value->quantity_amount?>" id="quantity_amount_1" name="quantity_amount[]" onfocus="this.select();" class="form-control integerchk aligning countID" placeholder="Qty/Amount"><span class="label_aligning"><?=unitName(getUnitIdByIgId($value->ingredient_id))?></span></td>
