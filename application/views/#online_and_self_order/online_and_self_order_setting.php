...
<section class="content-header">
    <h1>
        <?php echo "Configuración de pedidos en línea y por cuenta propia"; ?>
    </h1>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="alert alert-error ir_p_display_none" id="address_error">
                                <p>El campo Dirección es obligatorio.</p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p class="ir_cRed_bold_f18">Configuración Mesas</p>
                            <hr />
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 ir_w_100" id="dion" name="dion">
                                    ...
                                    <option
                                        ...
                                        value="dionn">El pedido irá directamente a la cocina</option>
                                    <option
                                        <?= isset($online_order_setting_information) && $online_order_setting_information->dion == 'diony'? 'selected' : '' ?>
                                        value="diony">Alguien decidirá desde la pantalla POS</option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p class="ir_cRed_bold_f18">Para Llevar Configuraciones</p>
                            <hr />
                        </div>
                    </div>
...
<script src="<?php echo base_url(); ?>assets/js/online_and_self_order_setting.js"></script>