...
<link rel="stylesheet" href="<?php echo base_url() ?>assets/css/set_opening_closing_time.css">
<!-- bootstrap time picker -->
...
<script src="<?php echo base_url() ?>assets/js/set_opening_closing_time.js"></script>
