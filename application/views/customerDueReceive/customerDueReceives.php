...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-md-6">
            <a class="right_btn" href="<?php echo base_url() ?>Customer_due_receive/addCustomerDueReceive"><button type="button"
                    class="btn btn-block btn-primary pull-right"><?php echo lang('add_customer_due_receive'); ?></button></a>
        </div>
    </div>
</section>
                    ...
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="ir_w_18"><?php echo lang('customer'); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <?php echo escape_output($value->amount) ?>
                                </td>
