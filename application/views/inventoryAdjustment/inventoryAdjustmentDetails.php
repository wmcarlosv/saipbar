        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                                    ...
                                    <tbody>
                                        ...
                                        if ($inventory_adjustment_ingredients && !empty($inventory_adjustment_ingredients)) {
                                            foreach ($inventory_adjustment_ingredients as $wi) {
                                                ...
                                                '<td class="ir_w_15">' . $wi->consumption_amount . unitName(getUnitIdByIgId($wi->ingredient_id)) . '</td>' .
                ...
                <div class="box-footer">
                    <a
                        href="<?php echo base_url() ?>Inventory_adjustment/addEditInventoryAdjustment/<?php echo escape_output($encrypted_id); ?>"><button
                            type="button" class="btn btn-primary"><?php echo lang('edit'); ?></button></a>
                    <a href="<?php echo base_url() ?>Inventory_adjustment/inventoryAdjustments"><button type="button"
