...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-md-6">
            <a class="right_btn" href="<?php echo base_url() ?>foodMenuCategory/addEditFoodMenuCategory"><button type="button"
                    class="btn btn-block btn-primary pull-right"><?php echo lang('add_food_menu_category'); ?></button></a>
        </div>
    </div>
</section>
