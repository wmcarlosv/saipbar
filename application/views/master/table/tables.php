...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-md-offset-4 col-md-2">
            <a href="<?php echo base_url() ?>table/addEditTable"><button type="button"
                    class="btn btn-block btn-primary pull-right"><?php echo lang('add_table'); ?></button></a>
        </div>
    </div>
</section>
                    ...
                    <table id="datatable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo getColumnById("tbl_rooms", "name", "id", $value->rooms_id); ?>
                                </td>
