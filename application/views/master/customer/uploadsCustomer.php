        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    ...
                    <a href="<?php echo base_url() ?>customer/customers"><button type="button"
                            class="btn btn-primary"><?php echo lang('back'); ?></button></a>
                    <a class="btn btn-primary" href="<?php echo base_url() ?>customer/downloadPDF/Customer_Upload.xlsx">
