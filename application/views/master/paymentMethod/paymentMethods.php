...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-md-offset-4 col-md-2">
            <a href="<?php echo base_url() ?>paymentMethod/addEditPaymentMethod"><button type="button"
                    class="btn btn-block btn-primary pull-right"><?php echo lang('add_payment_method'); ?></button></a>
        </div>
    </div>
</section>
