                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="name" class="form-control"
                                    ...
                                    value="<?php echo escape_output($room_information->name) ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="outlet">
                                    ...
                                    foreach ($outlets as $outlet):
                                        ?>
                                        <option <?=isset($room_information->outlet_id) && $room_information->outlet_id == $outlet->id?'selected':''?> value="<?php echo escape_output($outlet->id)?>"><?php echo escape_output($outlet->outlet_name)?></option>
                                        <?php
                                    endforeach;
                                    ?>
                                </select>
