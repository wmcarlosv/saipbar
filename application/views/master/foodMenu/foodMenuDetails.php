        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class=""> <?php echo escape_output($this->session->userdata('currency')); ?>
                                    <?php echo escape_output($food_menu_details->sale_price) ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-footer">
                    <a href="<?php echo base_url() ?>foodMenu/addEditFoodMenu/<?php echo escape_output($encrypted_id); ?>"><button
