            ...
            <div class="login-box-body">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" name="email_address"
                        ...
                        value="<?php if(APPLICATION_MODE == 'demo'){ echo "admin@ResetSv.com"; }else{ echo '';} ?>">
                </div>
                ...
                <?php echo form_close(); ?>
                    ...
                    ?>
                        <p>&nbsp;</p>
                    <p class="text-center"><?php echo lang('Click'); ?> <a target="_blank" href="<?=base_url()?>Authentication/index"><?php echo lang('here'); ?></a> <?php echo lang('if_you_face_issue_to_login'); ?></p>
                    <?php
                    endif;
                    ?>
