                    ...
                    foreach ($sale_object->items as $row) {
                        ...
                        <tr>
                            ...
                            <td class="no-border border-bottom text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . $row->menu_price_without_discount; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="no-border border-bottom text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . $modifier_price; ?></td>
                        </tr>
                        <?php } ?>
                        <?php }
                }
                    ...
                    <tfoot>
                        ...
                        <tr>
                           <th><?php echo lang('sub_total'); ?></th>
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . $sale_object->sub_total; ?>
                            </th>
                        </tr>
                        <?php
