        ...
        <div id="receiptData">
            ...
            <div id="receipt-data">
               ...
               <p><?php echo lang('date'); ?>:<?= escape_output(date($this->session->userdata('date_format'), strtotime($sale_object->sale_date))); ?>
                   ...
                   <?= ($sale_object->order_type=='1' ? "<br>".lang('waiter').": <b>" . escape_output($sale_object->waiter_name)."</b>" : '') ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="no-border border-bottom ir_wid_70"># <?php echo escape_output($i++); ?>:
                                ...
                                <small></small> <?php echo escape_output("$row->qty X $row->menu_unit_price"); ?>
                            </td>
                            <td class="no-border border-bottom text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($row->menu_price_without_discount); ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="no-border border-bottom text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($modifier_price); ?></td>
                        </tr>
                        <?php } ?>
                        <?php }
                            }
                    ...
                    <tfoot>
                        ...
                        <tr>
                           <th><?php echo lang('sub_total'); ?></th>
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($sale_object->sub_total); ?>
                            </th>
                        </tr>
                        <?php
                        ...
                        <th class="text-right">
                            <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($sale_object->total_discount_amount); ?>
                        </th>
                        </tr>
                        <?php
                        endif;
                        ...
                        <?php
                        if($sale_object->delivery_charge && $sale_object->delivery_charge!="0.00"):
                        ?>
                        <tr>
                       <th><?php echo lang('Service_Delivery_Charge'); ?></th>
                        <th class="text-right">
                            <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($sale_object->delivery_charge); ?>
                        </th>
                        </tr>
                        <?php
                        endif;
                        ...
                        <tr>
                            ...
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($single_tax->tax_field_amount); ?>
                            </th>
                        </tr>
                                <?php
                                endif;
                        ...
                        <tr>
                          <th><?php echo lang('grand_total'); ?></th>
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($sale_object->total_payable); ?>
                            </th>
                        </tr>
                          <?php
                        ...
                        <tr>
                          <th><?php echo lang('paid_amount'); ?></th>
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($sale_object->paid_amount); ?>
                            </th>
                        </tr>
                        <?php
                        endif;
                        ...
                        <tr>
                           <th><?php echo lang('due_amount'); ?></th>
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($sale_object->due_amount); ?>
                            </th>
                        </tr>
                        <?php
                        endif;
                        ...
                        <tr>
                           <th><?php echo lang('given_amount'); ?></th>
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($sale_object->given_amount); ?>
                            </th>
                        </tr>
                        <?php
                        endif;
                        ...
                        <tr>
                           <th><?php echo lang('change_amount'); ?></th>
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . escape_output($sale_object->change_amount); ?>
                            </th>
                        </tr>
                        <?php
                        endif;
