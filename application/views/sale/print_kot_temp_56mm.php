...
<head>
    <meta charset="utf-8">
    <title><?php echo lang('Invoice_No'); ?>: <?php echo $kot_info->order_number; ?></title>
...
<body>
        ...
        <div id="receiptData">
            ...
            <div id="receipt-data">
                <div class="ir_txt_center">
                  ...
                  <?php echo lang('Invoice_No'); ?><b>: </b><?php echo $kot_info->order_number; ?><br>
                ...
                <table class="table table-condensed">
                    ...
                    <tfoot>
                        <tr>
                            <th class="ir_txt_center" colspan="6"><?php echo lang('Total_Item_s'); ?>: <?php echo $totalItems; ?></th>
                        </tr>
                    </tfoot>
                </table>
    ...
    <script src="<?php echo base_url(); ?>assets/js/print_on_load.js"></script>
</body>
