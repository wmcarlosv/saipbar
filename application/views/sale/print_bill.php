               ...
               <p><?php echo lang('date'); ?>: <?= escape_output(date($this->session->userdata('date_format'), strtotime($sale_object->sale_date))); ?>
                ...
                ?>
                    ...
                    <tfoot>
                        ...
                        <th class="text-right">
                            <?php echo escape_output($this->session->userdata('currency')) . " " . $sale_object->total_discount_amount; ?>
                        </th>
                        </tr>
                        <?php
                        endif;
                       ...
                       <th><?php echo lang('Service_Delivery_Charge'); ?></th>
                        <th class="text-right">
                            <?php echo escape_output($this->session->userdata('currency')) . " " . $sale_object->delivery_charge; ?>
                        </th>
                        </tr>
                        <?php
                        endif;
                ...
                if ($this->session->userdata('collect_tax')=='Yes' && $sale_object->sale_vat_objects!=NULL):
                    ...
                    if($single_tax->tax_field_amount && $single_tax->tax_field_amount!="0.00"):
                        ...
                        <tr>
                            ...
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . $single_tax->tax_field_amount; ?>
                            </th>
                        </tr>
                        <?php
                        endif;
                ...
                ?>
                        <tr>
                          <th><?php echo lang('grand_total'); ?></th>
                            <th class="text-right">
                                <?php echo escape_output($this->session->userdata('currency')) . " " . $sale_object->total_payable; ?>
                            </th>
                        </tr>
                    </tfoot>
                </table>
