...
<section class="content-header dashboard_content_header <?=returnSessionLng()=="arabic"?'right_aligned"':''?>">
                <h1>
    ...
    if(isLMni()):
    ?>
    <form class="float_left" method="post" id="outlet_form" action="<?php echo base_url()?>Dashboard/dashboard">
        <select class="select_outlet_dashboard form-control" id="outlet_id_dashboard" name="outlet_id">
            <?php
    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="ir_w33_ft_h260">
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>foodMenu/addEditFoodMenu"><span
                                class="fa fa-book text-info"></span>+ <?php echo lang('food_menu'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>SupplierPayment/addSupplierPayment"><span
                                class="fa fa-user text-info"></span>+ <?php echo lang('supplier_payment'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none" href="<?php echo base_url(); ?>Sale/POS"><span
                                class="fa fa-television text-info"></span><?php echo lang('pos'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Expense/addEditExpense"><span
                                class="fa fa-money text-info"></span>+ <?php echo lang('expense'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Purchase/addEditPurchase"><span
                                class="fa fa-truck text-info"></span>+ <?php echo lang('purchase'); ?></a>
                    </div>
                    <div class="ir_w33_ft_h260">
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Report/dailySummaryReport"><span
                                class="fa fa-list text-info"></span><?php echo lang('daily_summary_report'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Report/registerReport"><span
                                class="fa fa-list text-info"></span><?php echo lang('register_report'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Report/profitLossReport"><span
                                class="fa fa-list text-info"></span><?php echo lang('profit_loss_report'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Report/saleReportByDate"><span
                                class="fa fa-list text-info"></span><?php echo lang('sales_report'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Report/foodMenuSales"><span
                                class="fa fa-list text-info"></span><?php echo lang('food_sales_report'); ?></a>
                    </div>
                    <div class="ir_w33_ft_h260">
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Setting/index"><span
                                class="fa fa-cog text-info"></span><?php echo lang('Setting'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Inventory/index"><span
                                class="fa fa-cube text-info"></span><?php echo lang('inventory'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Inventory_adjustment/inventoryAdjustments"><span
                                class="fa fa-adjust text-info"></span><?php echo lang('inventory_adjustment'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Customer_due_receive/customerDueReceives"><span
                                class="fa fa-users text-info"></span>+ <?php echo lang('customer_receive'); ?></a>
                        <a class="btn icon-btn btn-info ir_border_none"
                            href="<?php echo base_url(); ?>Attendance/addEditAttendance"><span
                                class="fa fa-clock-o text-info"></span>+ <?php echo lang('attendance'); ?></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        foreach ($low_stock_ingredients as $value) {
                            ...
                            <li>
                                ...
                                <div class="ir_fl_right_c_red_pr_5">
                                    <span><?= ($totalStock) ? escape_output($totalStock) : '0.0' ?></span>
                                </div>
                            </li>
                        <?php
                            endif;
                  ...
                  $key++;
                    ?>
                        <li>
                            ...
                            <div class="ir_fl_right_c_pr_5">
                                <span><?php echo escape_output($value->total_payable) ?></span>
                            </div>
                        </li>
                        <?php } } ?>
                    </ul>
