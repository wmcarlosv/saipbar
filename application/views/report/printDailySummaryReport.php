...
<script src="<?php echo base_url(); ?>assets/js/print_daily_summary_report.js"></script>
                ...
                <div class="box-body table-responsive">
                    ...
                    <table class="ir_w_100 tbl">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;<?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($sum_of_gtotal); ?></td>
                    ...
                    <table class="ir_w_100 tbl">
                        ...
                        if (!empty($result['sales']) && isset($result['sales'])):
                            foreach ($result['sales'] as $key => $value):
                                ...
                                <tr>
                                    ...
                                    <td><?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($value->paid_amount); ?></td>
                                    <td><?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($value->due_amount); ?></td>
                                </tr>
                                <?php
                            endforeach;
                        endif;
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td class="ir_fw_txt_right"><?php echo lang('sum'); ?></td>
                            <td>&nbsp;<?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($sum_of_stotal_payable); ?></td>
                            <td>&nbsp;<?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($sum_of_sdisc_actual); ?></td>
                            <td>&nbsp;<?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($sum_of_spaid_amount); ?></td>
                            <td>&nbsp;<?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($sum_of_sdue_amount); ?></td>
                        </tr>
                    </table>
