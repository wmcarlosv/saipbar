...
<section class="content-header">
    <h3 class="ir_txtCenter_mt0"><?php echo lang('waste_report'); ?></h3>
                    ...
                    <table id="datatable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($value->total_loss) ?></td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output(number_format($grandTotal,2)); ?></th>
                                <th><?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output(number_format($countTotal,2)); ?></th>
                                <th></th>
                            </tr>
                        </tfoot>
                    </table>
