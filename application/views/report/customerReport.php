...
<script src="<?php echo base_url(); ?>assets/js/customer_report.js"></script>
<section class="content-header">
    <h3 class="ir_txtCenter_mt0"><?php echo lang('customer_report'); ?></h3>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    <h3><?php echo lang('Customer_Report'); ?></h3>
                    <?php
                    ...
                    <br>
                    <h4 class="ir_txt_left_mb"><?php echo lang('sale'); ?></h4>
                    <table id="datatable" class="datatable table table-striped">
                        ...
                        <tr>
                            ...
                            <th>
                                    <?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output(number_format($pPaid, 2)) ?></th>
                            <th>
                                    <?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output(number_format($pDue, 2)) ?></th>
                        </tr>
                        </tfoot>
                    </table>
                    <br>
                    <h4 class="ir_txt_left_mb"><?php echo lang('due_receive'); ?></h4>
