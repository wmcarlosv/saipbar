...
<section class="content-header">
    <h3 class="ir_txtCenter_mt0"><?php echo lang('expense_report'); ?></h3>
                    ...
                    <table id="datatable" class="table table-striped">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($grandTotal); ?></th>
                                <th></th>
                                <th></th>
                            </tr>
                        </tfoot>
