                ...
                <div class="box-body table-responsive">
                    ...
                    <table id="datatable" class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th><?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($paidGrandTotal); ?></th>
                            <th><?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($dueGrandTotal); ?></th>
                            <th><?php echo escape_output($this->session->userdata('currency'))?> <?php echo escape_output($pGrandTotal); ?></th>
                            <th></th>
                        </tr>
                        </tfoot>
                    </table>
